...
namespace FantasyBaseball.CommonModels.UnitTests.Builders
{
    public class BattingStatsBuilderTest
    {
        ...
        [Fact] public void BuildWithNull() => Compare(new BattingStats(), new BattingStatsBuilder().AddStats(null).Build());
        ...
        [Fact] public void BuildWithMultiple() 
        {
            ...
            Compare(expected, new BattingStatsBuilder().AddStats(stats1).AddStats(stats2).Build());
        }
