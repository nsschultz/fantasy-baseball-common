...
namespace FantasyBaseball.CommonModels.UnitTests.Builders
{
    public class PitchingStatsBuilderTest
    {
        ...
        [Fact] public void BuildWithNull() => Compare(new PitchingStats(), new PitchingStatsBuilder().AddStats(null).Build());

        [Fact] public void BuildWithMultiple() 
        {
            ...
            Compare(expected, new PitchingStatsBuilder().AddStats(stats1).AddStats(stats2).Build());
        }
