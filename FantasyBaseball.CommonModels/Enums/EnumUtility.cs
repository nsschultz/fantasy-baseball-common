...
namespace FantasyBaseball.CommonModels.Enums
{
    ...
    public static class EnumUtility
    {
        ...
        public static T GetFromDescription<T>(string value) where T : Enum => 
            Enum.GetValues(typeof(T)).Cast<T>().FirstOrDefault(v => EqualsIgnoreCase(GetDescription(v), value));
        ...
        public static T GetFromKey<T>(string value) where T : Enum => 
            Enum.GetValues(typeof(T)).Cast<T>().FirstOrDefault(v => EqualsIgnoreCase(v.ToString(), value));
